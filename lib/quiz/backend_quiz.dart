...
class backend_quiz extends StatefulWidget {


  String jobtype1;
  backend_quiz(this.jobtype1);

  @override
  _backend_quizState createState() => _backend_quizState();



}

class _backend_quizState extends State<backend_quiz> {
