...
class front_end extends StatefulWidget
{
  @override
  State<front_end> createState() => _front_endState();
}



class _front_endState extends State<front_end>
{
          ...
          slivers: [
            ...
            StreamBuilder(
              stream: FirebaseFirestore.instance
                  ...
                  .where("itemTitle", isEqualTo: "FrontEnd")
                  .snapshots(),
